...
#define OS_FSYS SystemCoreClock   // MCU core frequency of Flasher ARM Pro V4
#define RCC_BASE_ADDR       RCC_BASE
...
#define USART1_BASE_ADDR    USART1_BASE
#define USART2_BASE_ADDR    USART2_BASE
